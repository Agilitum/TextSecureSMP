...
/**
 * @author George Politis modified by ludwig 27/06/15
 */
public class SMPInputStream extends FilterInputStream implements
	SerializationConstants {

	private static final String TAG = SMPInputStream.class.getSimpleName();

	public SMPInputStream(InputStream in) {
		super(in);
	}
	...
	private int readNumber(int length) throws IOException {
		...
		Log.d(TAG, "readNumber value: " + value);
		return value;
	}
/*
...
/*
	...
	public DHPublicKey readDHPublicKey() throws IOException {
		...
		try {
			return new SMPCryptoEngineImpl().getDHPublicKey(gyMpi);
		} catch (Exception ex) {
			throw new IOException();
		}
	}

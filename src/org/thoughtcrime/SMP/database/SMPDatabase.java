...
public class SMPDatabase extends MessagingDatabase {

	private static final String TAG = SMPDatabase.class.getSimpleName();

	public  static final String TABLE_NAME         = "smp";
	...
	public SMPDatabase(Context context, SQLiteOpenHelper databaseHelper) {
    ...
    */
	...
	public class Reader {
		...
		public SMPMessageRecord getNext() {
		...
		public SMPMessageRecord getCurrent() {
			...
			return new SMPMessageRecord(context, messageId, body, recipients,

...
import org.thoughtcrime.SMP.database.documents.NetworkFailureList;
...
import org.thoughtcrime.SMP.database.model.MediaMmsMessageRecord;
import org.thoughtcrime.SMP.database.model.MessageRecord;
import org.thoughtcrime.SMP.database.model.NotificationMmsMessageRecord;
...
import org.thoughtcrime.SMP.mms.TextSlide;
...
import static org.thoughtcrime.SMP.util.Util.canonicalizeNumberOrGroup;
...
public class MmsDatabase extends MessagingDatabase {
  ...
  public static final ExecutorService slideResolver = org.thoughtcrime.SMP.util.Util.newSingleThreadedLifoExecutor();
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (org.thoughtcrime.SMP.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).setUnread(threadId);
    }
  ...
  public class Reader {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = org.thoughtcrime.SMP.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = org.thoughtcrime.SMP.util.Util.toIsoBytes(transactionId);
